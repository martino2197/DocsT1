  ...
  useEffect(() => {
    ...
    if (logoImg) {
      ...
      if (location.pathname.startsWith('/docs/T1Comercios')) {
        theme === 'light' ? logoSrc = '/img/T1ComerciosLogo.svg' : logoSrc = '/img/T1ComerciosLogoDark.svg';
      } else if (location.pathname.startsWith('/docs/T1Pagos')) {
        theme === 'light' ? logoSrc = '/img/T1PagosLogos.svg' : logoSrc = '/img/T1PagosLogoDark.svg';
      } else {
        theme === 'light' ? logoSrc = '/img/t1envios-logo.svg' : logoSrc = '/img/T1EnviosLogoDark.svg';
      }
      logoImg.src = logoSrc;
    }
